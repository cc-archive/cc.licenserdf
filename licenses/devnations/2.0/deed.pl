      ...
      <div id="deed-main" align="left" dir="">
       <div id="deed-main-content">
        ...
        <div id="deed-conditions">
            ...
            <li rel="cc:requires" href="http://creativecommons.org/ns#Attribution" class="license by"><p><strong>Uznanie autorstwa</strong>.
                <span>Utwór należy oznaczyć w sposób określony przez Twórcę lub
Licencjodawcę</span></p></li>

    				<li />W celu ponownego użycia utworu lub rozpowszechniania utworu należy wyjaśnić innym warunki licencji, na której udostępnia się utwór.
    				<li />Każdy z tych warunków może zostać uchylony, jeśli uzyska się zezwolenie właściciela praw autorskich.
    			</ul>
        </div>
