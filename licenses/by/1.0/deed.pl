   ...
   rel="alternate nofollow" lang="zu">isiZulu</a>
    ...
    <div id="deed" align="left" class="green" dir="">  
      <div id="deed-head">
        ...
        <div id="deed-license">
	        <h2 property="dc:title">Uznanie autorstwa 1.0 Ogólny</h2>
        </div>
      </div>
...
Licencjodawcę</span>
		...
		<div id="attribution_help_panel">
          ...
          <div id="deed-newer">
    	      <p><a href="http://creativecommons.org/licenses/by/3.0/">Nowa wersja</a> tej licencji jest już dostępna. Należy jej używać do nowych utworów, a także rozważyć zmianę starej licencji na nową w utworach już udostępnionych. Żadne utwory nie są jednak <em>automatycznie</em> obejmowane nową licencją.</p>
          </div>
