...
<html xmlns="http://www.w3.org/1999/xhtml"
  ...
  <head>
    <title>Creative Commons &mdash;
      Uznanie autorstwa-Użycie niekomercyjne 2.0 Niemcy
...
<a href="./deed.zu" title="isiZulu" hreflang="zu"
   rel="alternate nofollow" xml:lang="zu">isiZulu</a>
	...
	<h1><span>Creative Commons License Deed</span></h1>
        ...
        <div id="deed-license">
	        <h2 property="dc:title">Uznanie autorstwa-Użycie niekomercyjne 2.0 Niemcy</h2>
        </div>
      </div>
	...
	<div id="deed-understanding">
	  ...
	  <ul class="understanding license-properties">
		...
		<li>
          ...
          <div id="deed-newer">
    	      <p><a href="http://creativecommons.org/licenses/by-nc/3.0/de/">Nowa wersja</a> tej licencji jest już dostępna. Należy jej używać do nowych utworów, a także rozważyć zmianę starej licencji na nową w utworach już udostępnionych. Żadne utwory nie są jednak <em>automatycznie</em> obejmowane nową licencją.</p>
          </div>
...
<p>Creative Commons nie jest firmą prawniczą i nie świadczy usług prawnych. Rozpowszechnianie, publikowanie lub tworzenie odnośników do niniejszego Commons Deed nie tworzy stosunku prawnego „adwokat-klient”. </p></div>
    ...
    <p id="footer">
      ...
      <a id="get_this"
         href="/choose/results-one?license_code=by-nc&amp;jurisdiction=de&amp;version=2.0&amp;lang=pl">Use this license for your own work.</a>
