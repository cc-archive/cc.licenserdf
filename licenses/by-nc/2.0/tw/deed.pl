...
Licencjodawcę</span>
		...
		<span id="nc-more-container" />
          ...
          <div id="deed-newer">
    	      <p><a href="http://creativecommons.org/licenses/by-nc/2.5/tw/">Nowa wersja</a> tej licencji jest już dostępna. Należy jej używać do nowych utworów, a także rozważyć zmianę starej licencji na nową w utworach już udostępnionych. Żadne utwory nie są jednak <em>automatycznie</em> obejmowane nową licencją.</p>
          </div>
