...
<html xmlns="http://www.w3.org/1999/xhtml"
  ...
  <head>
    <title>Creative Commons &mdash;
      Αναφορά προέλευσης-Μη Εμπορική Χρήση 2.0 Βραζιλία
...
<a href="./deed.zu" title="isiZulu" hreflang="zu"
   rel="alternate nofollow" xml:lang="zu">isiZulu</a>
	...
	<h1><span>Creative Commons License Deed</span></h1>
        ...
        <div id="deed-license">
	        <h2 property="dc:title">Αναφορά προέλευσης-Μη Εμπορική Χρήση 2.0 Βραζιλία</h2>
        </div>
      </div>
	...
	<div id="deed-understanding">
	  ...
	  <ul class="understanding license-properties">
		...
		<li>Μπορεί να υπάρχουν δικαιώματα άλλων ατόμων  είτε στην εργασία καθαυτή ή πως χρησιμοποιείται, όπως <a href="http://wiki.creativecommons.org/Frequently_Asked_Questions#When_are_publicity_rights_relevant.3F" class="helpLink" id="publicity_rights">δημοσιότητα</a> ή δικαιώματα απορρήτου.</li>
          ...
          <div id="deed-newer">
    	      <p>Μία <a href="http://creativecommons.org/licenses/by-nc/2.5/br/">νέα έκδοση</a> αυτής της άδειας είναι διαθέσιμη. Θα πρέπει να τη χρησιμοποιήσετε για νέα έργα, και ενδεχομένως για υπάρχοντα έργα που διέποντε από αυτή. Κανένα έργο <em>δεν υπεισέρχεται αυτόματα</em>παρόλα αυτά σε μία νέα άδεια.</p>
          </div>
...
Το νομικό πρόσωπο Creative Commons δεν είναι δικηγορική εταιρία και δεν παρέχει νομικές υπηρεσίες. Διανομή, εμφάνιση ή σύνδεση με το Περιληπτικό Μέρος δε δημιουργεί σχέση δικηγόρου-πελάτη.
    ...
    <p id="footer">
      ...
      <a id="get_this"
         href="/choose/results-one?license_code=by-nc&amp;jurisdiction=br&amp;version=2.0&amp;lang=el">Use this license for your own work.</a>
