...
<html xmlns="http://www.w3.org/1999/xhtml"
  ...
  <head>
    <title>Creative Commons &mdash;
      Reconocimiento-Sin obras derivadas 2.1 España
...
Creative Commons no es un bufete de abogados y no ofrece servicios legales. La distribución, la muestra, o el enlace de este Resumen no crea ningun vínculo abogado-cliente. 
    ...
    <p id="footer">
      ...
      <a id="get_this"
         href="/choose/results-one?license_code=by-nd&amp;jurisdiction=es&amp;version=2.1&amp;lang=es">Use this license for your own work.</a>
