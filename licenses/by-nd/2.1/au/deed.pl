   ...
   rel="alternate nofollow" lang="zu">isiZulu</a>
    ...
    <div id="deed" align="left" class="yellow" dir="">  
      <div id="deed-head">
        ...
        <div id="deed-license">
	        <h2 property="dc:title">Uznanie autorstwa-Bez utworów zależnych 2.1 Australia</h2>
        </div>
      </div>
...
Licencjodawcę</span>
		...
		<span id="nd-more-container" />
          ...
          <div id="deed-newer">
    	      <p><a href="http://creativecommons.org/licenses/by-nd/2.5/au/">Nowa wersja</a> tej licencji jest już dostępna. Należy jej używać do nowych utworów, a także rozważyć zmianę starej licencji na nową w utworach już udostępnionych. Żadne utwory nie są jednak <em>automatycznie</em> obejmowane nową licencją.</p>
          </div>
