...
στο έργο με τον τρόπο όπως αυτός έχει οριστεί από το δημιουργό ή το χορηγών την άδεια (αλλά όχι με τρόπο που να υποδηλώνει οτι παρέχουν επίσημη έγκριση σε σας ή για χρήση του έργου από εσάς).</span>
          ...
          <div id="deed-newer">
    	      <p>Μία <a href="http://creativecommons.org/licenses/by-nd/2.5/br/">νέα έκδοση</a> αυτής της άδειας είναι διαθέσιμη. Θα πρέπει να τη χρησιμποιήσετε για νέα έργα, και ενδεχομένως για υπάρχοντα έργα που διέποντα από αυτή. Κανένα έργο <em>δεν υπεισέρχεται αυτόματα</em>παρόλα αυτά σε μία νέα άδεια.</p>
          </div>
