   ...
   rel="alternate nofollow" lang="zu">isiZulu</a>
    ...
    <div id="deed" align="left" class="yellow" dir="">  
      <div id="deed-head">
        ...
        <div id="deed-license">
	        <h2 property="dc:title">Αναφορά-Όχι Παράγωγα Έργα 2.0 Ιαπωνία</h2>
        </div>
      </div>
    ...
    href="http://creativecommons.org/ns#Reproduction">Είναι ελεύθερη:</h3>
	  ...
	  <ul align="left" dir=""> 
		...
		<span id="nd-more-container" />
          ...
          <div id="deed-newer">
    	      <p>Μία <a href="http://creativecommons.org/licenses/by-nd/2.1/jp/">νέα έκδοση</a> αυτής της άδειας είναι διαθέσιμη. Θα πρέπει να τη χρησιμποιήσετε για νέα έργα, και ενδεχομένως για υπάρχοντα έργα που διέποντα από αυτή. Κανένα έργο <em>δεν υπεισέρχεται αυτόματα</em>παρόλα αυτά σε μία νέα άδεια.</p>
          </div>
