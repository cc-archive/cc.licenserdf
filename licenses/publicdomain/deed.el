...
<a href="./deed.zu" title="isiZulu" hreflang="zu"
  ...
  <p align="center"><em>Copyright-Only Dedication (based on United States law) or Public Domain Certification</em></p>
        ...
        <p>Το άτομο ή τα άτομα που έχουν συσχετίσει έργο με αυτό το αρχείο (αυτός που το προσφέρει ή πιστοποιεί) με το παρόν είτε (α) πιστοποιούν ότι, εν γνώσει τους,το έργο του οποίου η πατρότητα  εξακριβώθηκε, ανήκει στα κοινά (δημόσιο τομέα) της χώρας στην οποία αυτό δημοσιεύτηκε, είτε (β) προσφέρουν στα κοινά (δημόσιο τομέα) οποιοδήποτε δικαίωμα πνευματικής ιδιοκτησίας έχει ο προσφέρων το έργο, η πατρότητα του οποίου διαπιστώνεται παρακάτω. Αυτός που πιστοποιεί προσφέρει περαιτέρω οποιοδήποτε δικαίωμα επί των δικαιωμάτων πνευματικής ιδιοκτησίας  που τυχόν έχει με το έργο που σχετίζεται και για τους λόγους αυτούς περιγράφεται ως "αυτός που προσφέρει" παρακάτω.</p>

        <p>Αυτός που πιστοποιεί έχει κάνει τις απαραίτητες ενέργειες προκειμένου να εξακριβώσει το καθεστώς σχετικά με τα δικαιώματα πνευματικής ιδιοκτησίας στο έργο αυτό. Αυτός που πιστοποιεί αναγνωρίζει ότι όλες οι προσπάθειες που έκανε με καλή την πίστη δεν τον απαλάσσουν από τυχόν ευθύνη σε περίπτωση που το έργο του οποίου η πατρότητα εξακριβώθηκε δεν ανήκει στα κοινά (δημόσιο τομέα).</p>
        ...
        <p>Αυτός που προσφέρει αναγνωρίζει ότι από τη στιγμή που το έργο θα εισέλθει στα κοινά (δημόσιο τομέα), θα μπορεί ο καθένας ελεύθερα να το αναπαράγει, να το διανέμει, να το μεταδίδει, να το χρησιμοποιεί, να το τροποποιεί, να δημιουργεί παράγωγα έργα βασισμένα σε αυτό ή αλλιώς να το εκμεταλλεύεται ο καθένας για οποιονδήποτε σκοπό, εμπορικό ή μη εμπορικό, και με οποιονδήποτε τρόπο συμπεριλαμβανομένων και μεθόδων εκμετάλλευσης που δεν έχουν ακόμα εφευρεθεί ή συλληφθεί ως ιδέα.</p>
