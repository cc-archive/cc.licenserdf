   ...
   rel="alternate nofollow" xml:lang="zu">isiZulu</a>
    ...
    <div id="deed" style="text-align:left" class="yellow"
      ...
      <div id="deed-head">
        ...
        <div id="deed-license">
	        <h2 property="dc:title">Αναφορά-Μη Εμπορική Χρήση-Όχι Παράγωγα Έργα 2.0 Γερμανία</h2>
        </div>
      </div>
    ...
    resource="http://creativecommons.org/ns#Reproduction">Είναι ελεύθερη:</h3>
	  ...
	  <ul style="text-align:left" dir="ltr"> 
		...
		<span id="nd-more-container" />
          ...
          <div id="deed-newer">
    	      <p>Μία <a href="http://creativecommons.org/licenses/by-nc-nd/3.0/de/">νέα έκδοση</a> αυτής της άδειας είναι διαθέσιμη. Θα πρέπει να τη χρησιμποιήσετε για νέα έργα, και ενδεχομένως για υπάρχοντα έργα που διέποντα από αυτή. Κανένα έργο <em>δεν υπεισέρχεται αυτόματα</em>παρόλα αυτά σε μία νέα άδεια.</p>
          </div>
