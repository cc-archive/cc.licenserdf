    ...
    href="http://creativecommons.org/ns#Reproduction">Usted es libre de:</h3>
	  ...
	  <ul align="left" dir=""> 
		...
		<span id="nd-more-container" />
          ...
          <div id="deed-newer">
    	      <p>Existe una <a href="http://creativecommons.org/licenses/by-nc-nd/2.5/es/">versión nueva</a> de esta licencia. Debería utilizarla para sus nuevas obras, y puede utilizarla para cambiar la licencia de obras ya existentes. Sin embargo, ninguna obra queda <em>automáticamente</em> sujeta a esta nueva licencia.</p>
          </div>
