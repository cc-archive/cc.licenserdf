...
<html xmlns="http://www.w3.org/1999/xhtml"
  ...
  <head>
    <title>Creative Commons &mdash;
      Uveďte autora-Neužívejte dílo komerčně-Nezasahujte do díla 2.5 Spain
...
<a href="./deed.zu" title="isiZulu" hreflang="zu"
   rel="alternate nofollow" xml:lang="zu">isiZulu</a>
	...
	<h1><span>Creative Commons License Deed</span></h1>
        ...
        <div id="deed-license">
	        <h2 property="dc:title">Uveďte autora-Neužívejte dílo komerčně-Nezasahujte do díla 2.5 Spain</h2>
        </div>
      </div>
	  ...
	  <ul class="license-properties" style="text-align:left"
       dir="ltr"> 
            <li rel="cc:requires"
                ...
                class="license by">
	      <p><strong>Uveďte autora</strong> &mdash;
		<span id="attribution-container">Máte povinnost uvést údaje o autorovi a tomto díle způsobem, který stanovil autor nebo poskytovatel licence (ne však tak, aby vznikl dojem, že podporují Vás nebo způsob, jakým dílo užíváte).</span>
		...
		<div id="help_attribution_help" class="help_panel">
		  ...
		  <div class="bd">
            ...
            <li rel="cc:prohibits"
                ...
                class="license nc">
	      <p><strong>Neužívejte dílo komerčně</strong> &mdash;
		
		<span>Toto dílo nesmíte využít pro komerční účely.</span>
		<span id="nc-more-container" />
	      ...
	      <p><strong>Nezasahujte do díla</strong> &mdash;
		
		<span>Toto dílo  nesmíte  pozměňovat, doplňovat,  využívat celé  nebo částečně v  jiných dílech.</span>
	...
	<div id="deed-understanding">
	  ...
	  <ul class="understanding license-properties">
		...
		<li>případná práva třetích osob k dílu samotnému nebo způsobům jeho užití, jako například práva na ochranu osobnosti a soukromí. </li>
          ...
          <div id="deed-newer">
    	      <p>A <a href="http://creativecommons.org/licenses/by-nc-nd/3.0/es/">new version</a> of this license is available. You should use it for new works, and you may want to relicense existing works under it. No works are <em>automatically</em> put under the new license, however.</p>
          </div>
...
Organizace Creative Commons není advokátní kanceláří ani neposkytuje právní služby. Distribucí, zveřejněním či odkázání na tuto licenci nevzniká vztah mezi advokátem a klientem.
	...
	<p style="text-align:center">
     ...
     Toto je zkrácené znění plného textu licenčního ujednání, dostupného v následujících jazycích:
       <br />

     
         <a href="legalcode.ca">Katalánština</a> 
         <a href="legalcode.es">Spanish</a>

         
         

           <a href="legalcode.eu">Basque</a> 
           <a href="legalcode.gl">Galician</a>
    ...
    <p id="footer">
      ...
      <a id="get_this"
         href="/choose/results-one?license_code=by-nc-nd&amp;jurisdiction=es&amp;version=2.5&amp;lang=cs">Použijte tuto licenci pro vaši vlastní práci.</a>
