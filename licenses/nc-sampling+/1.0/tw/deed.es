        ...
        <div id="deed-rights" style="text-align:left"
             dir="ltr">
		      ...
		      <ul class="license-properties">
    				<li class="license samplingplus">Para muestrear, mash-up, o otra manera de transformar creativamente esta obra para fines no comerciales.</li>
    				
    				<li class="license samplingplus">Comunicar públicamente y distribuir copias de la obra completa con fines no comerciales (p.e., compartir ficheros o emisiones no comerciales via web)</li>
		      </ul>
        ...
        <div id="deed-conditions">
	        ...
	        <ul class="license-properties"
             style="text-align:left" dir="ltr">
    				<li class="license by">Debe reconocer los créditos de la obra de la manera especificada por el autor o el licenciador (pero no de una manera que sugiera que tiene su apoyo o apoyan el uso que hace de su obra).</li>
    				<li>Sólo puede utilizar esta obra para anunciar o promocionar una obra que haya creado partir de ésta.</li>
    				<li>Al reutilizar o distribuir la obra, tiene que dejar bien claro los términos de la licencia de esta obra.</li>
...
Creative Commons no es un bufete de abogados y no ofrece servicios legales. La distribución, la muestra, o el enlace de este Resumen no crea ningun vínculo abogado-cliente. 
    ...
    <p id="footer">
      ...
      <a id="get_this"
         href="/choose/results-one?license_code=nc-sampling%2B&amp;jurisdiction=tw&amp;version=1.0&amp;lang=es">Use this license for your own work.</a>
