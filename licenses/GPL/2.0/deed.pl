...
<p><span>GNU General Public License</span> to tzw. licencja <a href="http://www.gnu.org/philosophy/free-sw.html">Free Software</a>. Jak każda licencja Free Software zapewnia następujące swobody:</p>
			
			<ol class="gpl">
				<li class="gpl">Swoboda uruchamiania programu w dowolnym celu.</li>
				<li class="gpl">Swoboda studiowania zasady działania programu, aby zaadaptować go do własnych potrzeb.</li>
				<li class="gpl">Swoboda redystrybucji kopii, aby pomóc innym (np. sąsiadom).</li>
				<li class="gpl">Swoboda udoskonalania programu i publikowania własnych poprawek dla dobra całej społeczności.</li>
			</ol>
</div>
...
<p>Creative Commons nie jest firmą prawniczą i nie świadczy usług prawnych. Rozpowszechnianie, publikowanie lub tworzenie odnośników do niniejszego Commons Deed nie tworzy stosunku prawnego „adwokat-klient”. </p></div>
	...
	<p style="text-align:center">
      ...
      Ten tekst to przystępne podsumowanie Tekstu prawnego (całość <a href="http://www.gnu.org/licenses/old-licenses/gpl-2.0.html">GNU General Public License</a>). <a href="legalcode.pt">Portugalskie  tłumaczenie</a> jest także dostępne.
    ...
    <p id="footer">
      ...
      <a id="get_this"
         href="/license/results-one?license_code=GPL&amp;jurisdiction=-&amp;version=2.0&amp;lang=pl">Use this license for your own work.</a>
