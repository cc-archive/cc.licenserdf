	...
	<div id="deed-understanding">
	  ...
	  <ul class="understanding license-properties">
		...
		<li>
          ...
          <div id="deed-newer">
    	      <p>Existe una <a href="http://creativecommons.org/licenses/by-sa/3.0/es/">versión nueva</a> de esta licencia. Debería utilizarla para sus nuevas obras, y puede utilizarla para cambiar la licencia de obras ya existentes. Sin embargo, ninguna obra queda <em>automáticamente</em> sujeta a esta nueva licencia.</p>
          </div>
...
Creative Commons no es un bufete de abogados y no ofrece servicios legales. La distribución, la muestra, o el enlace de este Resumen no crea ningun vínculo abogado-cliente. 
    ...
    <p id="footer">
      ...
      <a id="get_this"
         href="/choose/results-one?license_code=by-sa&amp;jurisdiction=es&amp;version=2.1&amp;lang=es">Use this license for your own work.</a>
