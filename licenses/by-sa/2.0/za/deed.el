   ...
   rel="alternate nofollow" lang="zu">isiZulu</a>
    ...
    <div id="deed" align="left" class="green" dir="">  
      <div id="deed-head">
        ...
        <div id="deed-license">
	        <h2 property="dc:title">Αναφορά-Παρόμοια διανομή 2.0 Νότια Αφρική</h2>
        </div>
      </div>
    ...
    href="http://creativecommons.org/ns#Reproduction">Είναι ελεύθερη:</h3>
	  ...
	  <ul align="left" dir=""> 
		...
		<span id="sa-more-container" />
          ...
          <div id="deed-newer">
    	      <p>Μία <a href="http://creativecommons.org/licenses/by-sa/2.5/za/">νέα έκδοση</a> αυτής της άδειας είναι διαθέσιμη. Θα πρέπει να τη χρησιμποιήσετε για νέα έργα, και ενδεχομένως για υπάρχοντα έργα που διέποντα από αυτή. Κανένα έργο <em>δεν υπεισέρχεται αυτόματα</em>παρόλα αυτά σε μία νέα άδεια.</p>
          </div>
