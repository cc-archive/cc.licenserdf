   ...
   rel="alternate nofollow" lang="zu">isiZulu</a>
    ...
    <div id="deed" align="left" class="green" dir="">  
      <div id="deed-head">
        ...
        <div id="deed-license">
	        <h2 property="dc:title">Uznanie autorstwa-Na tych samych warunkach 2.0 Południowa Afryka</h2>
        </div>
      </div>
...
Licencjodawcę</span>
		...
		<span id="sa-more-container" />
          ...
          <div id="deed-newer">
    	      <p><a href="http://creativecommons.org/licenses/by-sa/2.5/za/">Nowa wersja</a> tej licencji jest już dostępna. Należy jej używać do nowych utworów, a także rozważyć zmianę starej licencji na nową w utworach już udostępnionych. Żadne utwory nie są jednak <em>automatycznie</em> obejmowane nową licencją.</p>
          </div>
