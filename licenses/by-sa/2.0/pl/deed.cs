	...
	<div id="deed-understanding">
	  ...
	  <ul class="understanding license-properties">
		...
		<li>
          ...
          <div id="deed-newer">
    	      <p>A <a href="http://creativecommons.org/licenses/by-sa/2.5/pl/">new version</a> of this license is available. You should use it for new works, and you may want to relicense existing works under it. No works are <em>automatically</em> put under the new license, however.</p>
          </div>
...
Organizace Creative Commons není advokátní kanceláří ani neposkytuje právní služby. Distribucí, zveřejněním či odkázání na tuto licenci nevzniká vztah mezi advokátem a klientem.
    ...
    <p id="footer">
      ...
      <a id="get_this"
         href="/license/results-one?license_code=by-sa&amp;jurisdiction=pl&amp;version=2.0&amp;lang=cs">
