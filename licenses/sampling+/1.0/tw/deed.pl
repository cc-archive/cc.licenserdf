        ...
        <div id="deed-rights" style="text-align:left"
             dir="ltr">
		      ...
		      <ul class="license-properties">
    				...
    				<li class="license sampling">Samplować, miksować lub w jakikolwiek inny kreatywny sposób zmieniać ten utwór w celach komercyjnych lub niekomercyjnych.</li>
...
<p>Creative Commons nie jest firmą prawniczą i nie świadczy usług prawnych. Rozpowszechnianie, publikowanie lub tworzenie odnośników do niniejszego Commons Deed nie tworzy stosunku prawnego „adwokat-klient”. </p></div>
    ...
    <p id="footer">
      ...
      <a id="get_this"
         href="/choose/results-one?license_code=sampling%2B&amp;jurisdiction=tw&amp;version=1.0&amp;lang=pl">Wykorzystaj tę licencję do licencjonowania własnych utworów.</a>
