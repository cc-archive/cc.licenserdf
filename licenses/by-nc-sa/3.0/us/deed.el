    ...
    href="http://creativecommons.org/ns#Reproduction">Είναι ελεύθερη:</h3>
	  ...
	  <ul align="left" dir=""> 
		...
		<span id="sa-more-container" />
            ...
            <li>Πέρα από τα δικαιώματα διασκευής που παρέχονται με αυτήν την άδεια, τίποτα σε αυτήν την άδεια δεν αποδυναμώνει ή περιορίζει το ηθικό δικαίωμα του δημιουργού.</li>
