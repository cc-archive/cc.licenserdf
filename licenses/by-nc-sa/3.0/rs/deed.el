...
<html xmlns="http://www.w3.org/1999/xhtml"
  ...
  <head>
    <title>Creative Commons &mdash;
      Αναφορά προέλευσης-Μη Εμπορική Χρήση-Παρόμοια διανομή 3.0 Σερβία
...
<a href="./deed.zu" title="isiZulu" hreflang="zu"
   rel="alternate nofollow" xml:lang="zu">isiZulu</a>
	...
	<h1><span>Creative Commons License Deed</span></h1>
        ...
        <div id="deed-license">
	        <h2 property="dc:title">Αναφορά προέλευσης-Μη Εμπορική Χρήση-Παρόμοια διανομή 3.0 Σερβία</h2>
        </div>
      </div>
...
Το νομικό πρόσωπο Creative Commons δεν είναι δικηγορική εταιρία και δεν παρέχει νομικές υπηρεσίες. Διανομή, εμφάνιση ή σύνδεση με το Περιληπτικό Μέρος δε δημιουργεί σχέση δικηγόρου-πελάτη.
	...
	<p style="text-align:center">
     ...
     Αυτή είναι μία εύληπτη περίληψη για τον απλό, μη νομομαθή χρήστη του Νομικού Μέρους (πλήρης άδεια), η οποία είναι διαθέσιμη στις ακόλουθες γλώσσες.
       <br />
         ...
         <a href="legalcode.sr-Cyrl">Σερβικά</a> 
    ...
    <p id="footer">
      ...
      <a id="get_this"
         href="/choose/results-one?license_code=by-nc-sa&amp;jurisdiction=rs&amp;version=3.0&amp;lang=el">Use this license for your own work.</a>
