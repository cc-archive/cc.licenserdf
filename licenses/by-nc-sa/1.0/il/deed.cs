...
<html xmlns="http://www.w3.org/1999/xhtml"
  ...
  <head>
    <title>Creative Commons &mdash;
      Uveďte autora-Neužívejte dílo komerčně-Zachovejte licenci 1.0 Israel
...
<a href="./deed.zu" title="isiZulu" hreflang="zu"
   rel="alternate nofollow" xml:lang="zu">isiZulu</a>
	...
	<h1><span>Creative Commons License Deed</span></h1>
        ...
        <div id="deed-license">
	        <h2 property="dc:title">Uveďte autora-Neužívejte dílo komerčně-Zachovejte licenci 1.0 Israel</h2>
        </div>
      </div>
	...
	<div id="deed-understanding">
	  ...
	  <ul class="understanding license-properties">
		...
		<li>případná práva třetích osob k dílu samotnému nebo způsobům jeho užití, jako například práva na ochranu osobnosti a soukromí. </li>
          ...
          <div id="deed-newer">
    	      <p>A <a href="http://creativecommons.org/licenses/by-nc-sa/2.5/il/">new version</a> of this license is available. You should use it for new works, and you may want to relicense existing works under it. No works are <em>automatically</em> put under the new license, however.</p>
          </div>
...
Organizace Creative Commons není advokátní kanceláří ani neposkytuje právní služby. Distribucí, zveřejněním či odkázání na tuto licenci nevzniká vztah mezi advokátem a klientem.
    ...
    <p id="footer">
      ...
      <a id="get_this"
         href="/choose/results-one?license_code=by-nc-sa&amp;jurisdiction=il&amp;version=1.0&amp;lang=cs">Použijte tuto licenci pro vaši vlastní práci.</a>
