...
<html xmlns="http://www.w3.org/1999/xhtml"
  ...
  <head>
    <title>Creative Commons &mdash;
      Reconocimiento-No comercial-Compartir bajo la misma licencia 2.1 España
	...
	<div id="deed-understanding">
	  ...
	  <ul class="understanding license-properties">
		...
		<li>
          ...
          <div id="deed-newer">
    	      <p>Existe una <a href="http://creativecommons.org/licenses/by-nc-sa/3.0/es/">versión nueva</a> de esta licencia. Debería utilizarla para sus nuevas obras, y puede utilizarla para cambiar la licencia de obras ya existentes. Sin embargo, ninguna obra queda <em>automáticamente</em> sujeta a esta nueva licencia.</p>
          </div>
...
Creative Commons no es un bufete de abogados y no ofrece servicios legales. La distribución, la muestra, o el enlace de este Resumen no crea ningun vínculo abogado-cliente. 
    ...
    <p id="footer">
      ...
      <a id="get_this"
         href="/choose/results-one?license_code=by-nc-sa&amp;jurisdiction=es&amp;version=2.1&amp;lang=es">Use this license for your own work.</a>
