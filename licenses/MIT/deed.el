...
<span id="devnations-container" />
        ...
        <div id="deed-conditions" align="left" dir="">
            ...
            <li rel="cc:requires"
                href="http://creativecommons.org/ns#Notice">Το λογότυπο υπόμνηση για τα δικαιώματα πνευματικής ιδιοκτησίας και η άδεια θα πρέπει να συμπεριλαμβάνεται σε όλα τα αντίγραφα ή σε ουσιωδώς μεγάλα κομμάτια του αντίστοιχου λογισμικού</li>
