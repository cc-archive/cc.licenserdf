...
<p>De <span>GNU Lesser General Public License</span> is <a href="http://www.gnu.org/philosophy/free-sw.html">Free Software</a> licentie. Net als bij andere free-software licenties verleent de licentiegever u met deze licentie de volgende vier rechten:</p>
			
			<ol class="gpl">
				<li class="gpl">Het recht om het programma uit te voeren zowel voor commerciële als niet-commerciële doeleinden.</li>
				<li class="gpl">Het recht om te onderzoeken hoe het programma werkt en om het aan uw eigen behoeften van de gebruiker aan te passen.</li>
				<li class="gpl">Het recht om exemplaren opnieuw te verspreiden om daarmee mensen om u heen van dienst te zijn.</li>
				<li class="gpl">Het recht om het programma te verbeteren en de verbeteringen bekend te maken ten behoeve van de gehele gemeenschap.</li>
			</ol>
</div>
...
<div id="deed-conditions">
  <h3></h3>
   ...
   <ul style="text-align:left" dir="ltr"> 
     ...
     <li class="license sa">Als u veranderingen aan uw kopie of kopieën van de library aanbrengt, mag u de resulterende library verspreiden zolang u dit onder de GNU Lesser General Public License doet. Programma's die naar de library linken mogen onder afwijkende voorwaarden verspreid worden zolang de library zelf bewerkt kan worden. Bij elke vertaling van de GNU Lesser General Public License moet de GNU Lesser General Public License bijgevoegd worden.</li>
...
Creative Commons is geen advocatenpraktijk en verleent geen juridische diensten. Het verspreiden van, tonen van of verwijzen naar deze Commons overeenkomst roept geen juridische relatie met Creative Commons in het leven.</div>
	...
	<p style="text-align:center">
      ...
      Dit is een vereenvoudigde (human-readable) versie van de Juridische overeenkomst (de volledige <a href="http://www.gnu.org/licenses/old-licenses/lgpl-2.1.html">GNU Lesser General Public License</a>). Er is tevens een <a href="legalcode.pt">Portugese vertaling</a> beschikbaar.
    ...
    <p id="footer">
      ...
      <a id="get_this"
         href="/license/results-one?license_code=LGPL&amp;jurisdiction=-&amp;version=2.1&amp;lang=nl">Gebruik deze licentie voor je eigen werk.</a>
