...
<p>η <span>GNU Lesser General Public License</span> είναι μία <a href="http://www.gnu.org/philosophy/free-sw.html">ελέυθερο Λογισμικό</a> άδεια.Όπως κάθε άδεια ελεύθερου λογισμικού, σας παρέχει τις ακόλουθες τέσσερις ελευθερίες.</p>
...
<div id="deed-conditions">
  <h3></h3>
   ...
   <ul align="left" dir=""> 
     ...
     <li class="license sa">Εάν τροποποιήσεις το αντίγραφο ή τα αντίγραφα του προγράμματος ή κάθε μέρους αυτού, ή αναπτύξετε πρόγραμμα που βασίζεται σε αυτό, θα μπορείτε να διανέμετε το έργο που θα προκύψει εάν κι εφόσοντο πράξετε υπό  <span>GNU Lesser General Public License</span>. Any translation of the <span>GNU Lesser General Public License</span> πρέπει να συνοδεύεται από <span>GNU Lesser General Public License</span>.</li>
