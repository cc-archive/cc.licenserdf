       ...
       <div id="deed-main-content">
        ...
        <div id="deed-newer" align="center"><h3>Αυτή η άδεια <a href="/retiredlicenses">έχει αποσυρθεί</a>. Μην τη χρησιμοποιείτε για νέα έργα.</h3></div>
		      ...
		      <ul>
    				...
    				<li class="license sampling" />Να δειγματίζετε, να ανακατεύετε, ή άλλως να μεταμορφώνετε δημιουργικά το έργο για εμπορικούς ή μη εμπορικούς σκοπούς.
        ...
        <div id="deed-conditions">
	        ...
	        <ul align="left" dir="">
    				...
    				<li />Για κάθε επαναχρησιμοποίηση του έργου σας θα πρέπει να αποσαφηνίσετε στους άλλους τους όρους της άδειας γι αυτό το έργο.
    				<li />Δε μπορείτε να ερμηνεύσετε, να κάνετε προσιτό στο κοινό ή να διανείμετε αντίγραφα από ολόκληρο αυτό το έργο για οποιοδήποτε σκοπό.
    			</ul>
