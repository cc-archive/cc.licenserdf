       ...
       <div id="deed-main-content" class="br">
        ...
        <div id="deed-newer" style="text-align:center"><h3>Αυτή η άδεια <a href="/retiredlicenses">έχει αποσυρθεί</a>. Μην τη χρησιμοποιείτε για νέα έργα.</h3></div>
		      ...
		      <ul class="license-properties">
    				...
    				<li class="license sampling">Να δειγματίζετε, να ανακατεύετε, ή άλλως να μεταμορφώνετε δημιουργικά το έργο για εμπορικούς ή μη εμπορικούς σκοπούς.</li>
        ...
        <div id="deed-conditions">
	        ...
	        <ul class="license-properties"
             style="text-align:left" dir="ltr">
    				...
    				<li>Για κάθε επαναχρησιμοποίηση του έργου σας θα πρέπει να αποσαφηνίσετε στους άλλους τους όρους της άδειας γι αυτό το έργο.</li>
    				<li>Δε μπορείτε να ερμηνεύσετε, να κάνετε προσιτό στο κοινό ή να διανείμετε αντίγραφα από ολόκληρο αυτό το έργο για οποιοδήποτε σκοπό.</li>
...
Το νομικό πρόσωπο Creative Commons δεν είναι δικηγορική εταιρία και δεν παρέχει νομικές υπηρεσίες. Διανομή, εμφάνιση ή σύνδεση με το Περιληπτικό Μέρος δε δημιουργεί σχέση δικηγόρου-πελάτη.
    ...
    <p id="footer">
      ...
      <a id="get_this"
         href="/choose/results-one?license_code=sampling&amp;jurisdiction=br&amp;version=1.0&amp;lang=el">Use this license for your own work.</a>
