	...
	<h1><span>Creative Commons License Deed</span></h1>
      ...
      <div id="deed-main" style="text-align:left" dir="ltr">
       <div id="deed-main-content" class="br">
        ...
        <div id="deed-newer" style="text-align:center"><h3>Deze licentie is <a href="/retiredlicenses">verouderd</a>. Gelieve niet te gebruiken voor nieuwe werken</h3></div>
        ...
        <div id="deed-conditions">
	        ...
	        <ul class="license-properties"
             style="text-align:left" dir="ltr">
    				...
    				<li>Bij hergebruik dient de gebruiker de licentievoorwaarden van dit werk kenbaar te maken aan derden.</li>
    				<li>De gebruiker mag dit gehele werk niet op- of uitvoeren, tonen of exemplaren van dit gehele werk verspreiden.</li>
...
Creative Commons is geen advocatenpraktijk en verleent geen juridische diensten. Het verspreiden van, tonen van of verwijzen naar deze Commons overeenkomst roept geen juridische relatie met Creative Commons in het leven.</div>
    ...
    <p id="footer">
      ...
      <a id="get_this"
         href="/choose/results-one?license_code=sampling&amp;jurisdiction=br&amp;version=1.0&amp;lang=nl">Gebruik deze licentie voor je eigen werk.</a>
